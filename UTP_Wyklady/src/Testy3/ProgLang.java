...
public class ProgLang {
    ...
    public static <T, K> Map<T, List<K>> sortMap(Map<T, List<K>> map, Comparator<Map.Entry<T, List<K>>> comparator) {
    ...
    public Map<String, List<String>> getProgsMapForNumOfLangsGreaterThan(int i) {
        return filterMAp(getMapOfProgramers(), e -> e.getValue().size() > i);
    }
