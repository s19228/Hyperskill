...
class TestDrive {
    public static void main(String[] args) {
        ...
        //veganPizzaDecor = new Tomato(new Spinach(new Cheese(new Tomato(new Vegan()))));
        //veganPizzaDecor = new Spinach(new Chicken(new Ham(new Tomato(new Cheese(new Vegan())))));
        System.out.println(veganPizzaDecor.getDescription() + " $" + formatSum(veganPizzaDecor.cost()));

        Pizza meatPizzaDecor = new MeatHeaven();
        //meatPizzaDecor = new Ham(new Cheese(new Chicken(new MeatHeaven())));
        //meatPizzaDecor = new Chicken(new Tomato(new MeatHeaven()));
