...
public class ProgLang {
    ...
    public ProgLang(String s) {
        try {
            Files.readAllLines(Paths.get(s)).stream().map(line -> line.split("\t")).forEach(in -> {
    ...
    public Map<String, List<String>> getMapOfProgramers() {
        return mapOfProgramers;
    }
    public Map<String, List<String>> getLangsMap() {
        return (Map<String, List<String>>) mapOfLanguages;
    }

    public Map<String, List<String>> getProgsMap() {
        return (Map<String, List<String>>) mapOfProgramers;
    }
    ...
    public Iterable<Object> getProgsMapSortedByNumOfLangs() {
        return (Iterable<Object>) sortByNumber(getMapOfProgramers());
    }

    public Map<String, List<String>> map(Map<String, List<String>> map, Predicate<Map.Entry<String, List<String>>> predicate) {
    ...
    public Map<String, List<String>> getProgsMapForNumOfLangsGreaterThan(int i) {
        return map(getMapOfProgramers(), m -> m.getValue().size() > i);
    }
}